...
SECRET_KEY = 'django-insecure-br%u(oe@rb3lq9y68=vq#hgk$%0lrayxm)3=ls7ab+cfjbozn%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['django-react-render.onrender.com', 'localhost', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR / 'django_api/frontend/templates' ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
